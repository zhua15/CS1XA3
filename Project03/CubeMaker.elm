...
platform = [((-20,-4),(-38,-36),black),((-4,30),(-39,-38),blue)]
...
type alias Model = 
    {
        ...
        player3 : (Bool,Color),
        player4 : (Bool,Color),
        velx : ((Float,Float),(Float,Float)),
        vely : ((Float,Float),(Float,Float)),
        posx : ((Float,Float),(Float,Float)),
        posy : ((Float,Float),(Float,Float)),
        response : String
    }
    ...
    case msg of
        Tick time (keyToState,(arrowX,arrowY),(wasdX,wasdY)) -> 
            let
                ...
                velx1new = velxUpdate model.posx model.posy model.velx model.vely wasdX isAlive1 1
                posx1new = posxUpdate model.posx model.posy model.velx model.vely isAlive1 1
                vely1new = velyUpdate model.posx model.posy model.velx model.vely wasdY isAlive1 1
                posy1new = posyUpdate model.posx model.posy model.velx model.vely isAlive1 1
                velx2new = velxUpdate model.posx model.posy model.velx model.vely arrowX isAlive2 2
                posx2new = posxUpdate model.posx model.posy model.velx model.vely isAlive2 2
                vely2new = velyUpdate model.posx model.posy model.velx model.vely arrowY isAlive2 2
                posy2new = posyUpdate model.posx model.posy model.velx model.vely isAlive2 2
                velx3new = velxUpdate model.posx model.posy model.velx model.vely 0 isAlive3 3
                posx3new = posxUpdate model.posx model.posy model.velx model.vely isAlive3 3
                vely3new = velyUpdate model.posx model.posy model.velx model.vely 0 isAlive3 3
                posy3new = posyUpdate model.posx model.posy model.velx model.vely isAlive3 3
                velx4new = velxUpdate model.posx model.posy model.velx model.vely 0 isAlive4 4
                posx4new = posxUpdate model.posx model.posy model.velx model.vely isAlive4 4
                vely4new = velyUpdate model.posx model.posy model.velx model.vely 0 isAlive4 4
                posy4new = posyUpdate model.posx model.posy model.velx model.vely isAlive4 4
...
velxUpdate : ((Float,Float),(Float,Float)) -> ((Float,Float),(Float,Float)) -> ((Float,Float),(Float,Float)) -> ((Float,Float),(Float,Float)) -> Float -> Bool -> Int -> Float
velxUpdate ((posx1,posx2),(posx3,posx4)) ((posy1,posy2),(posy3,posy4)) ((velx1,velx2),(velx3,velx4)) ((vely1,vely2),(vely3,vely4)) key isAlive num =    
    let
    ...
    if isAlive == False then
        ...
        0 + a*key
    else if helperVelx posx posy velx platform then
        0
    else if velx > 0 then
        velx + a*key - friction
    else if velx < 0 then
...
velyUpdate : ((Float,Float),(Float,Float)) -> ((Float,Float),(Float,Float)) -> ((Float,Float),(Float,Float)) -> ((Float,Float),(Float,Float)) -> Float -> Bool -> Int -> Float
velyUpdate ((posx1,posx2),(posx3,posx4)) ((posy1,posy2),(posy3,posy4)) ((velx1,velx2),(velx3,velx4)) ((vely1,vely2),(vely3,vely4)) key isAlive num =    
    let
        posx =  if num == 1 then posx1 else if num == 2 then posx2 else if num == 3 then posx3 else posx4
        posy =  if num == 1 then posy1 else if num == 2 then posy2 else if num == 3 then posy3 else posy4
        velx =  if num == 1 then velx1 else if num == 2 then velx2 else if num == 3 then velx3 else velx4
    ...
    if isAlive == False then
        0
    else if key == 1 && (posy == -(39.5 - (cubesize/2)) || isPlatform posx posy platform) then
        jumpStrength
    else
        if posy +vely >= (39.5 - (cubesize/2)) then
            ...
            if helperVelyT posx posy vely platform then
                0-g
            else if helperVelyB posx posy vely platform then
                0-g
            else
                vely-g

posxUpdate : ((Float,Float),(Float,Float)) -> ((Float,Float),(Float,Float)) -> ((Float,Float),(Float,Float)) -> ((Float,Float),(Float,Float)) -> Bool -> Int -> Float
posxUpdate ((posx1,posx2),(posx3,posx4)) ((posy1,posy2),(posy3,posy4)) ((velx1,velx2),(velx3,velx4)) ((vely1,vely2),(vely3,vely4)) isAlive num =    
    let
        posx =  if num == 1 then posx1 else if num == 2 then posx2 else if num == 3 then posx3 else posx4
        posy =  if num == 1 then posy1 else if num == 2 then posy2 else if num == 3 then posy3 else posy4
        velx =  if num == 1 then velx1 else if num == 2 then velx2 else if num == 3 then velx3 else velx4
    ...
    if isAlive == False then
        ...
        let
            (isTrueL,numL) = helperPosxL posx posy velx platform
            (isTrueR,numR) = helperPosxR posx posy velx platform
        in
        if isTrueL then
            numL
...
posyUpdate : ((Float,Float),(Float,Float)) -> ((Float,Float),(Float,Float)) -> ((Float,Float),(Float,Float)) -> ((Float,Float),(Float,Float)) ->Bool -> Int -> Float
posyUpdate ((posx1,posx2),(posx3,posx4)) ((posy1,posy2),(posy3,posy4)) ((velx1,velx2),(velx3,velx4)) ((vely1,vely2),(vely3,vely4)) isAlive num =    
    let
        posx =  if num == 1 then posx1 else if num == 2 then posx2 else if num == 3 then posx3 else posx4
        posy =  if num == 1 then posy1 else if num == 2 then posy2 else if num == 3 then posy3 else posy4
        velx =  if num == 1 then velx1 else if num == 2 then velx2 else if num == 3 then velx3 else velx4
    ...
    if isAlive == False then
        ...
        let
            (isTrueT,numT) = helperPosyT posx posy vely platform
            (isTrueB,numB) = helperPosyB posx posy vely platform
            (isTrueC,numC) = clipperCorner posx posy velx vely platform
        in 
        if isTrueT then
            numT
...
helperVelx : Float -> Float -> Float ->List((Float,Float),(Float,Float),Color) -> Bool   
...
helperVelyT : Float -> Float -> Float ->List((Float,Float),(Float,Float),Color) -> Bool
...
helperVelyB : Float -> Float -> Float ->List((Float,Float),(Float,Float),Color) -> Bool
...
helperPosxL : Float -> Float -> Float -> List((Float,Float),(Float,Float),Color) -> (Bool,Float)
...
helperPosxR : Float -> Float -> Float -> List((Float,Float),(Float,Float),Color) -> (Bool,Float)
...
helperPosyT : Float -> Float -> Float -> List((Float,Float),(Float,Float),Color) -> (Bool,Float)
...
helperPosyB : Float -> Float -> Float -> List((Float,Float),(Float,Float),Color) -> (Bool,Float)
...
clipperCorner : Float -> Float -> Float -> Float -> List((Float,Float),(Float,Float),Color) -> (Bool,Float)
...
helperCornerV : Float -> Float -> Float -> Float -> List((Float,Float),(Float,Float),Color) -> Bool
...
isPlatform : Float -> Float -> List((Float,Float),(Float,Float),Color) -> Bool
...
platformGenerate : Model -> List((Float,Float),(Float,Float),Color) -> List (Shape userMsg)
platformGenerate model x = 
    let
        header =  case head(x) of
                    Just v -> v
                    Nothing -> ((0,0),(0,0),blank)
    ...
    in 
    if x2 /= [] then
        [rectangle (abs(xmax - xmin)) (abs(ymax - ymin)) |> filled colour |> move (((xmin + xmax)/2),((ymax + ymin)/2))] ++ platformGenerate model x2
    else
